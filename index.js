...
client.on('ready', async () => {
  ...
  const r = new Discord.RichPresence()
    ...
    .setType('STREAMING')
    .setURL('https://youtu.be/hzk3kaSuKPk?si=X_RL8ItmNLkeqgOh') //Must be a youtube video link 
    .setState('agony')
    .setName('worstgen')
 ...
 .setAssetsLargeImage('https://i.pinimg.com/originals/f5/8b/0d/f58b0d9db0c1167ba887316b0657b22e.gif') //You can put links in tenor or discord and etc.
    .setAssetsLargeText('black star') //Text when you hover the Large image
    ...
    .addButton('geeked', 'https://youtu.be/MgKebqcV8o4?si=dgHDldkwXhPvTXw4')
    .addButton('out', 'https://youtu.be/cb5jYBG71-0?si=r3ZDEmsXqMRAL-_y');
